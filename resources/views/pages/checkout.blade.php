                ...
                <div class="row">
                        ...
                        <div class="card card-details">
                            ...
                            <div class="attendee">
                                ...
                                text-center">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="{{url('frontend/images/avatar-1.png')}}" alt="" srcset=""
                                                    height="60">
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{url('frontend/images/avatar-2.png')}}" alt="" srcset=""
                                                    height="60">
                                            </td>
                                            <td class="align-middle">
                                                Galih Pratama
                            ...
                            <div class="member mt-3">
                                ...
                                <form action="" class="form-inline">
                                    ...
                                    <label for="inputVisa" class="sr-only">VIAS</label>
                    ...
                    <div class="col-lg-4">
                        <div class="card card-details card-right">
                            ...
                            <div class="bank">
                                <div class="bank-item pb-3">
                                    <img src="{{url('frontend/images/ic_bank.png')}}" alt="" srcset="" class="bank-image">
                                ...
                                <div class="bank-item pb-3">
                                    <img src="{{url('frontend/images/ic_bank.png')}}" alt="" srcset=""
                                        class="bank-image">
                                    <div class="description">
                                        <h3>PT Nomads ID</h3>
                                        <p>
                        ...
                        <div class="join-container">
                            <a href="success.html"
                                class="btn btn-block btn-join-now
                            mt-3 py-2">
                                I Have Made Payment
                            </a>
                        </div>
